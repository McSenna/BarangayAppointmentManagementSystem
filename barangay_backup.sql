...
(1267, 'RESIDENT: REGISTER RESIDENT - 34914497568493 |  tan seblario ', '10-12-2025 2:22 PM', 'create'),
(1268, 'RESIDENT: tan seblario | LOGIN', '10-12-2025 2:23 PM', 'login'),
(1269, 'RESIDENT - 34914497568493: tan seblario | REQUEST CERTIFICATE (BARANGAY CLEARANCE) - JOB', '10-12-2025 2:23 PM', 'create'),
(1270, 'RESIDENT: tan seblario | LOGOUT', '10-12-2025 7:23 AM', 'logout'),
(1271, 'ADMIN: Admin Admin | LOGIN', '10-12-2025 2:23 PM', 'login'),
(1272, 'ADMIN: Admin Admin | LOGOUT', '10-12-2025 7:34 AM', 'logout'),
(1273, 'ADMIN: Admin Admin | LOGIN', '10-12-2025 2:34 PM', 'login'),
(1274, 'ADMIN: Admin Admin | LOGOUT', '10-12-2025 7:34 AM', 'logout'),
(1275, 'RESIDENT: tan seblario | LOGIN', '10-12-2025 2:34 PM', 'login'),
(1276, 'RESIDENT - 34914497568493 submitted a certificate request (Barangay Clearance)', '12/10/2025 2:35 PM', 'create'),
(1277, 'RESIDENT: tan seblario | LOGOUT', '10-12-2025 7:36 AM', 'logout'),
(1278, 'ADMIN: Admin Admin | LOGIN', '10-12-2025 2:36 PM', 'login'),
(1279, 'ADMIN: RESIDENT REQUEST CERTIFICATE ACCEPTED - 34914497568493 | PURPOSE JOB | MESSAGE none | DATE ISSUED  | DATE EXPIRED ', '10-12-2025 7:50 AM', 'updated'),
(1280, 'ADMIN: Admin Admin | LOGOUT', '10-12-2025 8:09 AM', 'logout'),
(1281, 'RESIDENT: tan seblario | LOGIN', '10-12-2025 3:09 PM', 'login'),
(1282, 'RESIDENT - 34914497568493 submitted a certificate request (Certificate of Residency)', '12/10/2025 3:09 PM', 'create'),
(1283, 'RESIDENT: tan seblario | LOGOUT', '10-12-2025 8:09 AM', 'logout'),
(1284, 'ADMIN: Admin Admin | LOGIN', '10-12-2025 3:09 PM', 'login'),
(1285, 'ADMIN ACCEPTED CERTIFICATE REQUEST - 34914497568493 | PURPOSE JOB | DATE ISSUED 12/10/2025 3:09 PM | DATE EXPIRED 12/13/2025', '10-12-2025 8:10 AM', 'updated'),
(1286, 'ADMIN: Admin Admin | LOGOUT', '10-12-2025 8:17 AM', 'logout'),
(1287, 'RESIDENT: tan seblario | LOGIN', '10-12-2025 3:17 PM', 'login'),
(1288, 'RESIDENT: tan seblario | LOGOUT', '10-12-2025 8:27 AM', 'logout'),
(1289, 'ADMIN: Admin Admin | LOGIN', '10-12-2025 3:30 PM', 'login'),
(1290, 'RESIDENT: tan seblario | LOGIN', '10-12-2025 3:41 PM', 'login'),
(1291, 'RESIDENT: tan seblario | LOGOUT', '10-12-2025 8:42 AM', 'logout'),
(1292, 'RESIDENT: REGISTER RESIDENT - 73040672015130 |  bonel bo ', '10-12-2025 3:46 PM', 'create'),
(1293, 'RESIDENT: bonel bo | LOGIN', '10-12-2025 3:46 PM', 'login'),
(1294, 'RESIDENT - 73040672015130 submitted a certificate request (Indigency Certificate)', '12/10/2025 3:47 PM', 'create'),
(1295, 'RESIDENT: bonel bo | LOGOUT', '10-12-2025 8:47 AM', 'logout'),
(1296, 'ADMIN: Admin Admin | LOGIN', '10-12-2025 3:47 PM', 'login');
...
CREATE TABLE `certificate_request` (
  ...
  `time_request` varchar(255) NOT NULL DEFAULT 'none',
  `datetime_request` varchar(255) NOT NULL DEFAULT 'none',
...
INSERT INTO `certificate_request` (`a_i`, `id`, `residence_id`, `certificate_type`, `purpose`, `message`, `date_request`, `time_request`, `datetime_request`, `date_issued`, `date_expired`, `status`) VALUES
(3, '182877860912102025150945413201558904769391cb964ffa', '34914497568493', 'Certificate of Residency', 'JOB', 'none', '2025-02-03', '15:09', '2025-02-03 15:09', '12/10/2025 3:09 PM', '12/13/2025', 'ACCEPTED'),
(4, '4310231151210202515471652710408909576939258480b7d', '73040672015130', 'Indigency Certificate', 'job', 'none', '2025-02-03', '15:47', '2025-02-03 15:47', '12/10/2025 3:47 PM', '12/13/2025 3:47 PM', 'PENDING');
...
(182, '34914497568493', 'tan', 'a', 'seblario', '17', '', '', 'Male', 'Single', 'catholic', 'filipino', '09123456789', 'josh@gmail.com', 'brgy 57 dap-dap legazpi city', '2007-12-29', ' bacacay', 'bacacay', '4500', 'baclayon', '143', 'zone 6', 'long', 'short', 'short', '11021526565', '', '', '', '', '', '', '', '', '', '', '', ''),
(183, '73040672015130', 'bonel', 'nel', 'bo', '21', '', '', 'Male', 'Single', 'catholic', 'filipino', '09995416565', 'bonel@gmail.com', 'purok 4 baclayon bacacay legazpi albay', '20004-02-02', 'orosite', 'bacacay', '4500', 'baclayon', '1023', 'puro 4', 'nel', 'bo', 'bo', '09956595959', '', '', '', '', '', '', '', '', '', '', '', '');
...
(182, '34914497568493', 'ACTIVE', '', 'NO', 'NO', '', 'NO', 'NO', '', '', '', '', 'NO', '12/10/2025 02:22 PM', 'none', 'none'),
(183, '73040672015130', 'ACTIVE', '', 'NO', 'NO', '', 'NO', 'NO', '', '', '', '', 'NO', '12/10/2025 03:46 PM', 'none', 'none');
...
(205, '34914497568493', 'tan', 'a', 'seblario', 'joshapinado', 'joshapinado', 'resident', '09123456789', '', ''),
(206, '73040672015130', 'bonel', 'nel', 'bo', 'bonel123', 'bonel123', 'resident', '09995416565', '', '');
...
--
ALTER TABLE `certificate_request`
  MODIFY `a_i` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
